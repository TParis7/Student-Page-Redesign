...
`;
  ...
  hero.innerHTML = `<img src="https://tparis7.github.io/Mentor-Page-Redesign/Copy%20of%20Versus_P3_20260910-IMG9479_MollJeanNye.jpg" alt="" class="fm-hero-watermark"><div class="fm-container"><div class="fm-hero-content"><h1>Your <em>career</em><br class="fm-h1-br-dt"> <em>accelerator</em>,<br class="fm-h1-br-mob"> powered<br class="fm-h1-br-dt"> by community.</h1><p>We are invested in your success. Get direct access to real professionals, opportunities, and career paths, 100% free on the P3 app.</p><div class="fm-hero-buttons"><a href="https://pulseofp3.org/download" class="fm-btn fm-btn-white fm-btn-arrow">Get the App</a><a href="https://platform.pulseofp3.org/demos/" target="_blank" rel="noopener" class="fm-btn fm-btn-white-outline">Try the Demo</a></div><div class="fm-hero-stats"><div><div class="fm-hero-stat-num">1,200+</div><div class="fm-hero-stat-label">Registered Users</div></div><div><div class="fm-hero-stat-num">$100K+</div><div class="fm-hero-stat-label">Scholarships Awarded</div></div><div><div class="fm-hero-stat-num">4.9&#9733;</div><div class="fm-hero-stat-label">App Store Rating</div></div></div></div></div>`;
  ...
  features.innerHTML = `<div class="fm-container"><div style="text-align:center; margin-bottom: 40px;"><div class="fm-section-label">Student Features</div><h2 class="fm-section-heading">Built for students. <em>Designed for your success.</em></h2><p class="fm-section-sub" style="margin:0 auto">Everything you need to connect, learn, and grow, right from your phone.</p></div><div class="fm-feature-row"><div class="fm-feature-visual"><img src="https://tparis7.github.io/Mentor-Page-Redesign/Connections.jpeg" alt="Smart Matching"></div><div class="fm-feature-text"><div class="fm-section-label">Smart Matching</div><h3>Personalized mentors, powered by AI</h3><p>Tell us your career goals, academic stage, and what kind of guidance you need. Our AI matches you with vetted professionals.</p><ul class="fm-feature-list"><li>Matched by career goals, education &amp; personal needs</li><li>You choose your mentor, so every connection is intentional</li><li>Two types: Guides (1:1 focused) and Experts (career coaching)</li></ul></div></div><div class="fm-feature-row reverse"><div class="fm-feature-visual"><img src="https://tparis7.github.io/Mentor-Page-Redesign/Video%20collage.jpeg" alt="Video Guidance"></div><div class="fm-feature-text"><div class="fm-section-label">Video Guidance</div><h3>Get real answers from real professionals</h3><p>Submit questions to your matched mentors and receive authentic 90-second video responses.</p><ul class="fm-feature-list"><li>Text questions, video answers: async and on your schedule</li><li>100+ discussion topics with conversation starters</li><li>Responses added to the public Community feed for all students</li></ul></div></div><div class="fm-feature-row"><div class="fm-feature-visual"><img src="https://tparis7.github.io/Mentor-Page-Redesign/iPhone%20Mockup%20hand.jpg" alt="Career Resources"></div><div class="fm-feature-text"><div class="fm-section-label">Career Resources</div><h3>Opportunities curated just for you</h3><p>From internships and jobs to college readiness guides and scholarships, P3 puts career resources at your fingertips.</p><ul class="fm-feature-list"><li>Internships, jobs, and volunteer opportunities</li><li>College readiness resources and application guides</li><li>Monthly P3 scholarship, with nearly $100K awarded since 2018</li></ul></div></div></div>`;
